...
class ContactForm {
  ...
  async sendFormData(data) {
    // Option 1: Envoi via script PHP (recommandé)
    return this.sendViaPHP(data);
    
    // Option 2: Envoi via EmailJS (alternative)
    // if (typeof EmailJS !== 'undefined') {
    //   return this.sendViaEmailJS(data);
    // }
    
    // Option 3: Envoi via Formspree (service gratuit)
    // return this.sendViaFormspree(data);
    
    // Option 4: Simulation pour test
